   ...
   $('#myTable').DataTable({
        ...
        serverSide: true,
          ajax: {
                ...
                url: "{{ URL::to('event/show/pariwisata')}}/",
                type: 'GET',
            },
        columns: [
...
<script type="text/javascript">
  ...
  if ($("#pameranForm").length > 0) {
    ...
    .then((willDelete) => {
      if (willDelete) {
           $.ajax({
                url: "{{ URL::to('/event/delete/pariwisata')}}/"+id,
                 type: "delete",
                 dataType: 'json',
