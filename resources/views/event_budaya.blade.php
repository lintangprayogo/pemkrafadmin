        ...
        <form id="pameranForm" name="pameranForm" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                     <input type="number" class="form-control" id="price" name="price" placeholder="Masukan Nama Pameran" value="" maxlength="50" required="" min="0">
                </div>
            </div>
...
<script type="text/javascript">
  ...
  if ($("#pameranForm").length > 0) {
    ...
    .then((willDelete) => {
      if (willDelete) {
           $.ajax({
                url: "{{ URL::to('/event/delete/budaya')}}/"+id,
                 type: "delete",
                 dataType: 'json',
