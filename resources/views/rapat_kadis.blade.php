        ...
        @endrole
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Data Rapat Kadis</h6>
            </div>
            <div class="card-body">
...
var deleteKadis = function(id) { swal({
...
.then((willDelete) => {
  if (willDelete) {
       $.ajax({
            url: "{{ URL::to('/rapat/kadis/delete')}}/"+id,
             type: "delete",
             dataType: 'json',
